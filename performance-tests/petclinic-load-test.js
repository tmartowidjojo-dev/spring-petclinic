...
export let options = {
    ...
    thresholds: {
        ...
        // Latency: 95% of all requests must complete within 800ms
        'http_req_duration': ['p(95)<800'],
        
        // Specific thresholds for the bundled flows (Page Load Times)
...
export default function () {
    ...
    group('02_Owner Lookup Flow', function () {
        ...
        // View detail page (assuming success leads to owner 1 page)
    ...
    group('04_Add New Owner Flow', function () {
        ...
        // Generate unique name for each VU and iteration
        ...
        let resPost = http.post(
            ...
            // Specify Content-Type for form submission
            {
                headers: {
